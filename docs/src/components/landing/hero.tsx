...
import { FlowNode, FlowLine, FloatingBadge, StatusBadge } from "./flow-primitives";
    ...
    >
      ...
      <div className="relative space-y-6 p-4">
        ...
        <div className="flex items-center justify-center gap-0">
          <FlowNode label="Event" color="amber" size="sm" delay={0.4} icon={
            <svg className="size-3" viewBox="0 0 12 12" fill="none"><path d="M6 1L10 6L6 11" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg>
          } />
        ...
        <div className="flex items-start justify-center">
          <div className="space-y-2.5">
            ...
            >
              ...
              <FlowNode label="api.acme.co" color="gray" size="sm" delay={1.1} />
            ...
            >
              ...
              <FlowNode label="hooks.stripe.io" color="gray" size="sm" delay={1.3} />
